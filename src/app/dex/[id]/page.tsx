...
function EffRow({ titleKey, entries, emptyKey }: { titleKey: string; entries: TypeMult[]; emptyKey: string }) {
  return (
    <div className="grid grid-cols-[7.5rem_1fr] items-start gap-x-3 gap-y-1">
      <span className="pt-1 text-[0.68rem] uppercase tracking-wide text-text-dim"><T k={titleKey} /></span>
      {entries.length ? (
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        ...
        <Reveal className="card p-5">
          ...
          <div className="mb-2 text-[0.6rem] uppercase tracking-wide text-text-dim"><T k="cr.defenseSub" /></div>
          ...
          <div className="mb-2 text-[0.6rem] uppercase tracking-wide text-text-dim"><T k="cr.attackSub" /></div>
          <div className="flex flex-col gap-3 text-sm">
