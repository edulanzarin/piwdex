...
import { PackageOpen, MapPinned, Calculator, FlaskConical, Egg, TrendingUp, Swords } from "lucide-react";
...
export const MetaIcon = ({ size = 52 }: { size?: number }) => (
  <Swords size={size} strokeWidth={1.5} aria-hidden />
);
