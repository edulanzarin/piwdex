    ...
    <>
      ...
      >
        <span className="flex min-w-0 flex-1 items-center gap-1.5">
          {prefix ? <span className="pix shrink-0 text-[9px] text-text-mute">{prefix}</span> : null}
              ...
              return (
                <li key={o.value}>
                  <button
                    ...
                    className={cn(
                      "flex w-full items-center gap-2 rounded-pix px-2 py-1.5 text-left text-[12px] transition-colors",
                  ...
                  >
                    ...
                    {o.hint ? <span className="shrink-0 text-[10px] text-text-mute">{o.hint}</span> : null}
